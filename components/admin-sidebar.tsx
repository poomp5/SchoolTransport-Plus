...
const AdminSidebar = () => {
    ...
    return (
      <>
        ...
        <div
          ref={sidebarRef}
          className={`fixed left-0 top-0 z-40 h-full w-64 transform bg-[#8B0000] shadow-lg transition-transform duration-300 ease-in-out lg:translate-x-0 ${
            ...
            {navigationItems.map((item) => {
              ...
              return (
                <Link
                  key={item.href}
                  href={item.href}
                  className={`flex items-center gap-4 px-6 py-4 text-white transition-colors ${
                    isActive
                      ? "bg-[#6B0000]"
