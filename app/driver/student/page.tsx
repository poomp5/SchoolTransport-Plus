                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-gray-500 table-cell md:hidden">ม.4/9 · เลขประจำตัว 27147</div>
                                    </div>
                                </div>
                            </td>
                            <td className="px-6 py-4 hidden md:table-cell">
                                <span className="bg-gray-100 text-gray-800 text-sm font-medium px-2.5 py-0.5 rounded">ม.4/9</span>
                            </td>
                            <td className="px-6 py-4 hidden md:table-cell">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-gray-500 table-cell md:hidden">ม.4/9 · เลขประจำตัว 27178</div>
                                    </div>
                                </div>
                            </td>
                            <td className="px-6 py-4 hidden md:table-cell">
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <div className="font-semibold text-gray-900">นายปุญญพัฒน์ กูลมนุญ</div>
                                            <div className="text-xs text-gray-500 table-cell md:hidden">ม.4/9 · เลขประจำตัว 27200</div>
                                    </div>
                                </div>
                            </td>
                            <td className="px-6 py-4 hidden md:table-cell">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-gray-500 table-cell md:hidden">ม.4/9 · เลขประจำตัว 27194</div>
                                    </div>
                                </div>
                            </td>
                            <td className="px-6 py-4 hidden md:table-cell">
