...
const FALLBACK_SRC =
  ...
  encodeURIComponent(
    `<svg xmlns='http://www.w3.org/2000/svg' width='120' height='120'>
      ...
      <text x='50%' y='50%' dominant-baseline='middle' text-anchor='middle' fill='#6b7280' font-size='20' font-family='Arial'>No Img</text>
    </svg>`
  );
...
export default function Home() {
  ...
  const handleClick = (id: number, sourceList: ListType) => {
    moveStudent(id, sourceList, sourceList === "waiting" ? "onBus" : "waiting");
  };
