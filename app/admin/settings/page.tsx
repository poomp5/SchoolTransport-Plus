...
import { Bus, User, Megaphone } from "lucide-react";
        ...
        <div className="flex min-h-screen mb-24">
            ...
            <div className="flex-1 lg:ml-64 mt-8 p-6">
                ...
                <div className="border-b flex">
                    <button className={`flex items-center gap-2 px-4 py-2 text-gray-700 ${activeTab === "bus" ? "border-b-2 border-red-800 text-red-800" : "hover:text-red-800"}`} onClick={() => setActiveTab("bus")}>
                        <Bus className="w-5 h-5" /> รถรับส่ง
                    </button>
                    <button className={`flex items-center gap-2 px-4 py-2 text-gray-700 ${activeTab === "driver" ? "border-b-2 border-red-800 text-red-800" : "hover:text-red-800"}`} onClick={() => setActiveTab("driver")}>
                        <User className="w-5 h-5" /> ผู้ขับขี่
                    </button>
                    <button className={`flex items-center gap-2 px-4 py-2 text-gray-700 ${activeTab === "announcement" ? "border-b-2 border-red-800 text-red-800" : "hover:text-red-800"}`} onClick={() => setActiveTab("announcement")}>
